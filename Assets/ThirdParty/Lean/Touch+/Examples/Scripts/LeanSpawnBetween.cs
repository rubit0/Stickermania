...
{
	/// <summary>This component allows you to spawn a prefab between two points.</summary>
	public class LeanSpawnBetween : MonoBehaviour
	{
		...
		public void Spawn(Vector3 start, Vector3 end)
		{
			if (Prefab != null)
			{
				...
				if (rigidbody3D != null)
				{
					rigidbody3D.linearVelocity = direction * VelocityMultiplier;
				}
				...
				if (rigidbody2D != null)
				{
					rigidbody2D.linearVelocity = direction * VelocityMultiplier;
				}
			}
		}
	}
