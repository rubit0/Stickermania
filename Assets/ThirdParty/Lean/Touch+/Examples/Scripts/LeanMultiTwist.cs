...
namespace Lean.Touch
{
	...
	public class LeanMultiTwist : MonoBehaviour
	{
		...
		public FloatEvent OnTwist { get { if (onTwist == null) onTwist = new FloatEvent(); return onTwist; } } [FormerlySerializedAs("OnTwist")] [SerializeField] private FloatEvent onTwist;
