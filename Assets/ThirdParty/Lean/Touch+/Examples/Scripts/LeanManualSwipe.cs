...
namespace Lean.Touch
{
	...
	public class LeanManualSwipe : MonoBehaviour
	{
		// Event signature
		...
		public FingerEvent OnSwipe { get { if (onSwipe == null) onSwipe = new FingerEvent(); return OnSwipe; } } [FormerlySerializedAs("onSwipe")] [SerializeField] protected FingerEvent onSwipe;
		...
		protected virtual void FingerUp(LeanFinger finger)
		{
