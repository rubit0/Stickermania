...
namespace Lean.Touch
{
	...
	public class LeanMultiSwipe : MonoBehaviour
	{
		...
		public FingerListEvent OnSwipe { get { if (onSwipe == null) onSwipe = new FingerListEvent(); return onSwipe; } } [FormerlySerializedAs("OnSwipe")] [SerializeField] private FingerListEvent onSwipe;
