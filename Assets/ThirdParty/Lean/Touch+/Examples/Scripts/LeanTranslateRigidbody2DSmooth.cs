...
{
	/// <summary>This modifies LeanTranslateRigidbody2D to be smooth.</summary>
	public class LeanTranslateRigidbody2DSmooth : LeanTranslateRigidbody2D
	{
		...
		protected override void FixedUpdate()
		{
			...
			{
				// Dampen the velocity
				cachedRigidbody.linearVelocity *= LeanTouch.GetDampenFactor(Dampening, Time.fixedDeltaTime);
			}
		}
	}
}