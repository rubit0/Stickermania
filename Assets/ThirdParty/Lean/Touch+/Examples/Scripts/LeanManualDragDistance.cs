...
namespace Lean.Touch
{
	...
	public class LeanManualDragDistance : MonoBehaviour
	{
		...
		public FloatEvent OnDistance { get { if (onDistance == null) onDistance = new FloatEvent(); return onDistance; } } [FormerlySerializedAs("OnDistance")] [SerializeField] private FloatEvent onDistance;
