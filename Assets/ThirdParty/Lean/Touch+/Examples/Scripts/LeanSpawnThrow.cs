...
{
	/// <summary>This script can be used to spawn a GameObject via an event.</summary>
	public class LeanSpawnThrow : MonoBehaviour
	{
		...
		public void Spawn(LeanFinger finger)
		{
			if (Prefab != null)
			{
				...
				if (rigidbody3D != null)
				{
					rigidbody3D.linearVelocity = vector * ForceMultiplier;
				}
				...
				if (rigidbody2D != null)
				{
					rigidbody2D.linearVelocity = vector * ForceMultiplier;
				}
			}
		}
	}
