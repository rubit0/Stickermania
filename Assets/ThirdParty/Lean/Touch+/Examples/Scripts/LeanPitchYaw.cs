...
{
	/// <summary>This script allows you to tilt & pan the current GameObject (e.g. camera) by dragging your finger(s).</summary>
	[ExecuteInEditMode]
	public class LeanPitchYaw : MonoBehaviour
	{
		...
		[Tooltip("If you call the ResetRotation method, this allows you to set the Pitch/Yaw rotation this will be set to.")]
