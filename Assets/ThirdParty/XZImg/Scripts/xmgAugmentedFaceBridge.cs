...
public class xmgAugmentedFaceBridge
{
    ...
    public static void xzimgCamera_create([In][Out] ref xmgVideoCaptureParams videoCaptureParams)
    {
        ...
        {
            AndroidJavaClass xzimg_video_plugin = new AndroidJavaClass("com.xzimg.videocaptureface.VideoCaptureAPI");
    ...
    [DllImport("__Internal")]
    public static extern int tmp_xzimgCamera_create([In][Out] ref xmgVideoCaptureParams videoCaptureParams);
    [DllImport("__Internal")]
    public static extern int tmp_xzimgCamera_delete();
    [DllImport("__Internal")]
    public static extern int tmp_xzimgCamera_getCaptureWidth();
    [DllImport("__Internal")]
    public static extern int tmp_xzimgCamera_getCaptureHeight();
    [DllImport("__Internal")]
    public static extern int tmp_xzimgCamera_getImage(System.IntPtr rgba_frame);
#endif
