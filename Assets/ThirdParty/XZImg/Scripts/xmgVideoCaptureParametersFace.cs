...
[System.Serializable]
public class xmgVideoCaptureParametersFace
{
    ...
    public double GetMainCameraFovV()
    {
        ...
        double trackingCamera_fovh_radian = xmgToolsFace.ConvertToRadian((double)CameraVerticalFOV);
        double trackingCamera_fovv_radian;
        if (videoPlaneFittingMode == xmgVideoPlaneFittingMode.FitScreenHorizontally)
            trackingCamera_fovv_radian = xmgToolsFace.ConvertHorizontalFovToVerticalFov(trackingCamera_fovh_radian, (double)screen_AR);
        else
            trackingCamera_fovv_radian = xmgToolsFace.ConvertHorizontalFovToVerticalFov(trackingCamera_fovh_radian, (double)video_AR);
        return xmgToolsFace.ConvertToDegree(trackingCamera_fovv_radian);
    }
    ...
    public double GetPortraitMainCameraFovV()
    {
        ...
        {
            trackingCamera_fovv_radian = xmgToolsFace.ConvertHorizontalFovToVerticalFov(trackingCamera_fovh_radian, (double)video_AR);
            trackingCamera_fovv_radian = xmgToolsFace.ConvertVerticalFovToHorizontalFov(trackingCamera_fovv_radian, (double)screen_AR);
        }
    ...
    public double[] GetVideoPlaneScale(double videoPlaneDistance)
    {
        ...
        if (videoPlaneFittingMode == xmgVideoPlaneFittingMode.FitScreenHorizontally)
        {
            double mainCamera_fovv_radian = xmgToolsFace.ConvertToRadian((double)GetMainCameraFovV());
            double mainCamera_fovh_radian = xmgToolsFace.ConvertVerticalFovToHorizontalFov(mainCamera_fovv_radian, (double)screen_AR);
