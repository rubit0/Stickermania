...
namespace SA.Android.Vending.BillingClient
{
    ...
    public class AN_BillingClient : AN_LinkedObject
    {
        ...
        {
            private const string k_NativeBillingClientBuilder = "com.stansassets.billing.AN_BillingClientBuilder";
        ...
        private const string k_NativeBillingClient = "com.stansassets.billing.AN_BillingClient";
        ...
        /// or you can explicitly acknowledge the purchase via {@link #acknowledgePurchase).
        /// For subscriptions use {@link #acknowledgePurchase).
        ///
        ...
        /// 
        /// Note: It also means that INAPP items are supported for purchasing,
